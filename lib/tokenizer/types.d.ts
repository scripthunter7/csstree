...
export const LeftSquareBracket: 19;
export const RightSquareBracket: 20;
export const LeftParenthesis: 21;
export const RightParenthesis: 22;
export const LeftCurlyBracket: 23;
export const RightCurlyBracket: 24;
